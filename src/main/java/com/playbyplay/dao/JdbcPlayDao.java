...
public class JdbcPlayDao extends BaseDao implements PlayDao {
    ...
    public void importPlays(List<String> pbpLinks) {
        try {
            String currentYear = gameDao.getCurrentYear().toString();
